...
class FileSystemDatabase:
    ...
    def seed(self):
        ...
        li = [
            ["john", "jane", "jack", "jill", "jeff", "jess", "joel", "joan", "jake", "joke", "jose", "josh", "jude", "judi", "jean"],
